package com.example.algos;/*
   Implements a dictionary (with integer keys and any value type) as a SkipList.
   The insert and find code is taken from 16.2.2 in Cliff Shaffer's
   textbook ().
   Stephanie made a few adjustments. 
   The code is pseudo-random.
*/
